        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-grid"></i> add Ads</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" required="" placeholder="ex: This Title Ads" name="name">
              @error('name')
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" required="" placeholder="ex:  Your Display Name" name="Display">
              @error('Display')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
                  ...
                  <div class="col-xl-12">
                    <div class="card card-transparent flex-row">
                      <ul class="nav nav-tabs nav-tabs-simple nav-tabs-left bg-white" id="tab-3">
                        <li class="nav-item">
                          <a class="padding-left" href="#"  data-toggle="tab" data-target="#Image"><i class="pg-image"></i> Image</a>
                        </li>
                        <li class="nav-item">
