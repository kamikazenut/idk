        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="fa  fa-gamepad"></i> add Game</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
          ...
          <div class="card-body">
           <form action="{{ route('Posts.store') }}" method="POST"  role="form" enctype="multipart/form-data"> 
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" required="" placeholder="ex:  The title for your Game English" 
                      ...
                      <div class="tab-content bg-white col-xl-11">
                        <div class="tab-pane" id="French">
                          <div class="form-group form-group-default required">
                            ...
                            <input type="text" name="Title_fr" class="form-control" placeholder="ex:  The title for your Game"> 
                          </div>
                          <!-- START card -->
                          <div class="form-group">
                            <textarea class="form-control" name="body_fr" placeholder="Game Content French" rows="10"></textarea>
                          </div>
                        </div>
                        <div class="tab-pane active" id="Arabic">
                          <div class="form-group form-group-default required">
                            <label>Game Title Arabic</label>
                            <input type="text" class="form-control" name="Title_ar" required="" placeholder="ex:  The title for your Game"> 
                          </div>
                          <!-- START card -->
                          <div class="form-group">
                            <textarea class="form-control" name="body_ar" placeholder="Game Content Arabic" rows="10"></textarea>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div class="card-body">
            ...
            <div class="form-group form-group-default input-group">
              <div class="form-input-group">
                ...
                <input type="text" class="form-control" placeholder="Game Content Meta" name="meta_description">
              </div>
            </div>
            <div class="form-group form-group-default input-group">
              <div class="form-input-group">
                <label>Meta Keywords</label>
                <input type="text" class="form-control" placeholder="Game Content Description" name="meta_keywords">
              </div>
            </div>
            <div class="form-group form-group-default input-group">
              <div class="form-input-group">
                <label>Size (20G - 10MB)</label>
                <input type="text" class="form-control" placeholder="Game Size" name="seo_title">
              </div>
            </div>
            <div class="form-group form-group-default input-group">
              <div class="form-input-group">
