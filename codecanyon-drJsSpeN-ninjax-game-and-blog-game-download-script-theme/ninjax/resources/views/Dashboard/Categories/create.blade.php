        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-folder"></i> add Category</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
          ...
          <div class="card-body">
            <form action="{{ route('Categories.store') }}" method="POST"  role="form" enctype="multipart/form-data"> 
              ...
              <div class="form-group form-group-default required">
                ...
                <input type="text" class="form-control" required="" placeholder="ex: Title Category" name="Title_ar">
                @error('Title_ar')
                   <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
              <div class="form-group form-group-default required">
                ...
                <input type="text" class="form-control" required="" placeholder="ex: Title Category" name="Title_fr">
                @error('Title_fr')
                   <div class="alert alert-danger">{{ $message }}</div>
                @enderror
              </div>
