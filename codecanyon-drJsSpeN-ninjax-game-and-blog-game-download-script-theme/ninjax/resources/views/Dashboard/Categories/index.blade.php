        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-folder"></i> Categories <a href="{{ route('Categories.create') }}" class="btn btn-tag btn-success btn-tag-rounded">Add Category</a></h3>
              </div>
            </div>
            <!-- END card -->
          </div>
  ...
  <div class=" container-fluid container-fixed-lg bg-white">
    ...
    <div class="card card-transparent">
      <div class="card-header ">
        <div class="card-title">Table Categories
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="v-align-middle text-right">
                <p>
                  <a href="{{ route('Categories.edit',$Category->slug) }}" class="btn btn-complete btn-cons btn-animated from-left fa fa-edit"><span>Edit</span></a>
