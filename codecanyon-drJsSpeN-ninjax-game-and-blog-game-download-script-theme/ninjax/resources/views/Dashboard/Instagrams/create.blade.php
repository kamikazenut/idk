    ...
    <div class=" container-fluid  container-fixed-lg">
      <div class="inner">
        ...
        <ol class="breadcrumb">  
          ...
          <li class="breadcrumb-item active">Create Instagram</li>
        </ol>
        <!-- END BREADCRUMB -->
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-ui"></i> add Instagram</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
        ...
        <div class="card card-default">
          ...
          <form action="{{ route('Instagrams.store') }}" method="POST"  role="form" enctype="multipart/form-data"> 
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" required="" placeholder="ex: Instagram English" id="Title_en" name="Title_en">
              @error('Title_en')
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('Title_ar') is-invalid @enderror" required="" placeholder="ex: Instagram arabic" id="Title_ar" name="Title_ar">
              @error('Title_ar')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('Title_fr') is-invalid @enderror" required="" placeholder="ex: Instagram france" id="Title_fr" name="Title_fr">
              @error('Title_fr')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
