        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-menu"></i> Menus 
                  <button class="btn btn-tag btn-success btn-tag-rounded" data-target="#modalFillIn" data-toggle="modal" id="btnFillSizeToggler2">Add Menu</button>
                </h3>
              </div>
            </div>
            <!-- END card -->
        ...
        <div class="modal-dialog ">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="text-left p-b-5"><span class="semi-bold">Create Menu</h5>
              </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header clearfix text-left">
                ...
                <h5>Item Menu</h5>
                <p>You can output this Item Menu anywhere</p>
              </div>
              <div class="modal-body">
                  ...
                  <div class="form-group-attached">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group form-group-default">
                          <label for="Title_en">Title Item Menu English</label>
                     ...
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group form-group-default">
                          <label for="Title_ar">Title Item Menu Arabic</label>
                     ...
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group form-group-default">
                          <label for="Title_fr">Title Item Menu France</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group form-group-default">
                          <label>Url Item Menu (www.example.com/Category)</label>
              ...
              <div class="row">
                <div class="col-md-4 m-t-10 sm-m-t-10">
                  <button type="submit" class="btn btn-primary btn-block m-t-5">Item Menu</button>
                </div>
              </div>
              </form>
            </div>
      ...
      <div class="col-lg-12">
        <div class="card card-default bg-success mt20">
          <div class="card-header  separator">
            <div class="card-title">Menu Builder Static 
            </div>
          </div>
          <div class="card-body">
            <p class="text-black hint-text">You can output this Menu anywhere on your site by calling Foreach(Menus() as Menu)</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="card card-borderless">
          <ul class="nav nav-tabs nav-tabs-simple" role="tablist" data-init-reponsive-tabs="dropdownfx">
            <li class="nav-item">
              <a class="active" data-toggle="tab" role="tab" data-target="#MenuBuilder" href="#">Menu Builder</a>
            </li>
            <!-- ================================ Menus Content Start ======================== -->
            @foreach($Menus as $Menu)
            <li class="nav-item">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="MenuBuilder">
              <div class="row column-seperation">
                <div class="col-lg-6">
                  <h3>
                    Menu Builder Static <button class="btn btn-complete btn-cons" id="btnStickUpSizeToggler">Item Menu</button>
                    <p>
                      You can output this Menu anywhere on your site by calling Foreach(Menus() as Menu)
                    </p>
                  </h3>
                </div>
              </div>
            ...
            <div class="tab-pane" id="{{ $Menu->id }}">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <p>You can output this menu anywhere on your site by calling (Edit your Menu in Helper File)</p>
                  <br>
                    <!-- ====================== links Menu Content Start store =============================================== -->
                    @foreach($Menu->menu_items as $item)  
                   <div id="card-circular-color" class="card card-default">
                    <div class="card-header">
                      <div class="card-title">Target Item Menu ({{ $item->target }})
                      </div>
                      ...
                      @csrf
                      @method('DELETE')
                      <button class="btn btn-danger btn-cons"  type="submit"> Delete </button>
                      </form>   
                      </div>
                      </div>
                    </div>
                    <div class="card-body">
                      <h3>
                      {{ $item->Title_en }}</h3>
                      <p>Url Item Menu (<a href="{{ url('')}}/{{ $item->url }}" target="_blank">{{ $item->url }}</a>) & Order Item Number ({{ $item->order }})
                      </p>
                    </div>
                   </div>
                   @endforeach
