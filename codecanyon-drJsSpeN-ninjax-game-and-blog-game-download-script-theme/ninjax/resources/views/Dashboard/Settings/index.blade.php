        ...
        <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
          <div class="inner">
            <div class="pull-bottom bottom-left m-b-40 sm-p-l-15">
              <h5 class="text-white no-margin">welcome Settings</h5>
              <h1 class="text-white no-margin"><span class="semi-bold">Settings</span> cover</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="day" data-social="day">
            ...
            <div class="card no-border bg-transparent full-width" data-social="item">
              ...
              <div class="container-fluid p-t-30 p-b-30 ">
                <div class="row">
                  <div class="col-lg-4">
                    <p class="no-margin fs-16"> How To Use: </p>
              ...
              <div class="card-body">
                <div class="scrollable">
                  <div class="demo-card-scrollable">
                    <h3>
                     <span class="semi-bold">{{ $Setting->key  }} <a href="{{ route('Settings.edit',$Setting->id) }}" class="btn btn-tag btn-tag-light btn-tag-rounded m-r-20">Edit</a></span>
