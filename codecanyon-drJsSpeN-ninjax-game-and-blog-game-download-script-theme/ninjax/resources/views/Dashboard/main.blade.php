...
<img src="{{ asset(option('logo')) }}" class="brand width-20" data-src="{{ asset(option('logo')) }}">
...
<span class="details">{{ option('SiteTitle')  }} Dashboard</span>
</a>
<span class="bg-primary icon-thumbnail"  data-toggle-pin="sidebar"><i class="fa fs-12 font-size-zero"></i></span>
</li>
<li>
<a href="javascript:;"><span class="title">Roles</span>
...
<li>
<a href="{{ url('Dashboard/Roles/create') }}">Create Role</a>
<span class="icon-thumbnail">R</span>
</li>
</ul>
</li>
...
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="fa fa-male"></i></span>
<ul class="sub-menu">
<li>
...
<li>
<a href="{{ url('Dashboard/Users/create') }}">Create User</a>
<span class="icon-thumbnail">U</span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">Games</span>
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="fa fa-gamepad"></i></span>
<ul class="sub-menu">
<li>
<a href="{{ url('Dashboard/Posts') }}">Games</a>
<span class="icon-thumbnail">P</span>
</li>
<li>
<a href="{{ url('Dashboard/Posts/create') }}">Create Game</a>
<span class="icon-thumbnail">P</span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">Categores</span>
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class=" pg-charts"></i></span>
<ul class="sub-menu">
<li>
<a href="{{ url('Dashboard/Categories') }}">Categores</a>
<span class="icon-thumbnail">C</span>
</li>
<li>
<a href="{{ url('Dashboard/Categories/create') }}">Create Category</a>
<span class="icon-thumbnail">C</span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">Teams</span>
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="pg-comment"></i></span>
<ul class="sub-menu">
<li>
<a href="{{ url('Dashboard/Clients') }}">Team</a>
<span class="icon-thumbnail">T</span>
</li>
<li>
<a href="{{ url('Dashboard/Clients/create') }}">Create Team</a>
<span class="icon-thumbnail">T</span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">Ads Manager</span>
<span class=" arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="pg-grid"></i></span>
<ul class="sub-menu">
<li class="">
<a href="{{ url('Dashboard/AdSense') }}">Ads</a>
<span class="icon-thumbnail">A</span>
</li>
<li class="">
<a href="{{ url('Dashboard/AdSense/create') }}">Create Ads</a>
<span class="icon-thumbnail">A</span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">Menu Maker</span>
<span class=" arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="pg-menu_justify"></i></span>
<ul class="sub-menu">
<li class="">
<a href="{{ url('Dashboard/Menus') }}">Menu</a>
...
<li>
<a href="javascript:;"><span class="title">Media</span>
<span class=" arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="pg-camera"></i></span>
<ul class="sub-menu">
<li class="">
<a href="{{ url('Dashboard/Media') }}">Media</a>
<span class="icon-thumbnail">M</span>
</li>
<li class="">
<a href="{{ url('Dashboard/image/upload') }}">Create Media</a>
<span class="icon-thumbnail">A</span>
</li>
</ul>
</li>
<li>
<a href="{{ url('Dashboard/Galleries') }}"><span class="title">Tournaments</span></a>
<span class="bg-complete icon-thumbnail"><i class="pg-image"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Instagrams') }}"><span class="title">Instagrams</span></a>
<span class="bg-complete icon-thumbnail"><i class="fa fa-instagram"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Messages') }}"><span class="title">Messages</span></a>
<span class="bg-complete icon-thumbnail"><i class=" pg-inbox"></i></span>
</li>
<li class="">
...
<a href="{{ url('Dashboard/Settings') }}" class="dropdown-item"><i class="pg-settings_small"></i> Settings</a>
@if(isset(Auth::user()->name))
<a href="{{ url('Dashboard/Users') }}/{{ Auth::user()->name }}/edit" class="dropdown-item"><i class="pg-outdent"></i> Edit Profile</a>
@else
@endif
...
<span class="hint-text">Copyright &copy; 2024 </span>
<span class="font-montserrat">{{ option('SiteTitle')  }}</span>.
<span class="hint-text">All rights reserved. </span>
<span class="sm-block"><a href="{{ url('') }}" class="m-l-10 m-r-10">Your Site</a> <span class="muted">|
</p>
<p class="small no-margin pull-right sm-pull-reset">
{{ option('SiteTitle')  }} <span class="hint-text">&amp; made with Love</span>
</p>
<div class="clearfix"></div>
</div>
</div>
