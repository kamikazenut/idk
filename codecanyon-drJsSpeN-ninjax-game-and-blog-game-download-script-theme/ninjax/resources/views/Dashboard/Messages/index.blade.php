        ...
        <div class=" container-fluid   container-fixed-lg sm-p-l-0 sm-p-r-0">
          <div class="inner">
            <div class="pull-bottom bottom-left m-b-40 sm-p-l-15">
              <h5 class="text-white no-margin">Our Messages</h5>
              <h1 class="text-white no-margin"><span class="semi-bold">{{ option('SiteTitle')  }}</span> Messages</h1>
            </div>
          </div> 
        </div>
      </div>
            ...
            <div class="card social-card share col2 m-t-30 m-b-30 m-r-30" data-social="item">
              ...
              <div class="card-header clearfix">
                ...
                <div class="card-description">
                  ...
                  @csrf
                  @method('DELETE')
                  <button class="btn btn-tag  btn-tag-danger float-right-zero" type="submit">Remove</button>
                  </form>
                </div>
              </div>
              <!-- END ITEM -->
