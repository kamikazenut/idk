        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class=" pg-ui"></i> Teams <a href="{{ route('Clients.create') }}" class="btn btn-tag btn-success btn-tag-rounded">Add Team</a></h3>
              </div>
            </div>
            <!-- END card -->
          </div>
  ...
  <div class=" container-fluid   container-fixed-lg bg-white">
    ...
    <div class="card card-transparent">
      <div class="card-header ">
        <div class="card-title">Table Teams
        </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="v-align-middle text-right">
                <p>
                  <a href="{{ route('Clients.edit',$Client->Title_en) }}" class="btn btn-complete btn-cons btn-animated from-left fa fa-edit"><span>Edit</span></a>
